...
import { getDeletedNotes } from "@/lib/notes";
import { restoreNoteAction } from "./restore-action";
  ...
  return (
    <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 py-10">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm uppercase tracking-[0.2em] text-slate-500">Trash</p>
          <h1 className="text-3xl font-semibold text-slate-900">Deleted notes</h1>
          <p className="text-sm text-slate-600">
            Items here can be restored until permanently deleted.
          </p>
        </div>
        <Link
          href="/app"
